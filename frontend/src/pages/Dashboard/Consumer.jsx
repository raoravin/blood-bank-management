...
const BloodUsed = () => {
  ...
  const initialPage = parseInt(
    localStorage.getItem("currentPage_bloodUsed"),
    10
  );
  ...
  const handlePageChange = (page) => {
    setCurrentPage(page);
    localStorage.setItem("currentPage_bloodUsed", page.toString());
  };
                ...
                <tbody className="">
                  {noTodosFound ? (
                    ...
                    visibleTodos.map((item) => (
                      ...
                      >
                        <td class="px-6 py-4 truncate">{item?.bloodGroup}</td>
                        <td class="px-6 py-4 truncate">
                          {item?.organisation?.organisationName}
                        </td>
                        <td class="px-6 py-4 truncate">{item?.quantity}</td>
                        <td class="px-6 py-4 truncate">
