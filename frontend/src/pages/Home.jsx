        ...
        <div className="w-full md:w-1/2 md:px-3">
          <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
            <h1 className="text-xl font-extrabold tracking-tight text-gray-900 sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl">
              <span className="block xl:inline">Hello Welcome <br /> Blood</span>
              <span className="block text-indigo-600 xl:inline"> {user?.role}</span>
            </h1>
            <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">Blood donation is an altruistic act where a person voluntarily donates blood, typically through a blood donation center or a mobile blood drive. </p>
  ...
  <section className="w-full bg-white pt-7 pb-7 md:pt-20 md:pb-24">
    <div className="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
      ...
      <div className="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
        ...
        <p className="pt-4 pb-8 m-0 leading-7 text-gray-700 border-0 border-gray-300 sm:pr-12 xl:pr-32 lg:text-lg">Foster an environment that encourages and supports blood donation efforts within your organization, contributing to a culture of giving and community support.
        </p>
        <ul className="p-0 m-0 leading-6 border-0 border-gray-300">
          <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
            <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Maximize lifesaving impact
          </li>
          <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
            <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Accelerate support for critical medical needs
          </li>
          <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
            <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Discover effective strategies
          </li>
        </ul>
      </div>
    </div>
    <div className="box-border flex flex-col items-center content-center px-8 mx-auto mt-2 leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">
      <div className="box-border w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
        ...
        Join the movement and make a life-saving difference. We are at the forefront of blood donation services, ensuring a seamless experience for donors and recipients alike:
        </p>
        <ul className="p-0 m-0 leading-6 border-0 border-gray-300">
          <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
            <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Streamlined Blood Donation Process
          </li>
          <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
            <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span> Comprehensive Health Screenings
          </li>
          <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
      ...
      <div className="box-border relative w-full max-w-md px-4 mt-10 mb-4 text-center bg-no-repeat bg-contain border-solid md:mt-0 md:max-w-none lg:mb-0 md:w-1/2">
        <img src="https://png.pngtree.com/png-vector/20210512/ourmid/pngtree-doctor-and-donation-of-the-womens-donation-day-illustration-png-image_3271810.jpg" className="pl-4 object-contain sm:pr-10 xl:pl-10 lg:pr-32" />
      </div>
    </div>
  </section>
      ...
      <div className="flex flex-wrap items-center -mx-3">
        <div className="order-1 w-full px-3 lg:w-1/2 lg:order-0">
          <div className="w-full lg:max-w-md">
            <h2 className="mb-4 text-3xl font-bold leading-tight tracking-tight sm:text-4xl font-heading"> Here's how you can tailor the content to focus on blood donation:

</h2>
            <p className="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">Empowering you with everything you need for successful blood donation campaigns! Making a difference in healthcare has never been simpler.:</p>
            <ul>
              <li className="flex items-center py-2 space-x-4 xl:py-3">
                ...
                <span className="font-medium text-gray-500">Efficient Blood Donation Processing and Delivery</span>
              </li>
              <li className="flex items-center py-2 space-x-4 xl:py-3">
                ...
                <span className="font-medium text-gray-500">Comprehensive Tracking and Monitoring Solutions</span>
              </li>
              <li className="flex items-center py-2 space-x-4 xl:py-3">
                <svg className="w-8 h-8 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                <span className="font-medium text-gray-500">Ensuring 100% Protection and Security for Blood Donation
</span>
              </li>
            </ul>
          </div>
